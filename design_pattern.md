...
朝鲜的金将军在一次科学技术大会上提出一项计划，朝鲜也要发展新能源汽车，要求工业与信息化部牵头3个月内搞出来样车
这个计划可难倒了工业与信息化部的领导，因为他们清楚朝鲜的技术水平
但是将军的命令就是命令，不能不执行，不能不说办不到；于是抽了一包又一包的白头山牌香烟终于想到了一个办法，就是所有核心零部件从东大采购，朝鲜套壳。
他们梳理了需要采购的核心部件： 电机、电控、电池； 加上其他的自产部件就可以组装成一辆车了， 于是找来了和平牌汽车的设计师设计汽车外观。

2 months later..
两个月后，样车终于问世了，为啥速度这么快提前完成了？是因为用了 "外观模式", 套壳生产出的。
...
将军第二天来到总装车间视察指导, 发现车机部分是中文的（其他地方是黑盒看不到），就现场问道，为什么开机画面是中文？ 
吓得负责人连忙解释道: 中文是联合国的官方语言之一，我们阿里郎到时要向东大出口赚外汇..
金将军岂能这么好糊弄，将军一怒之下当场换了项目负责人，并要求限期整改回炉重造.. 并且这次要将启动界面部分以及内容注入主体思想..,并且在普通模式的基础上增加朝鲜特色的主体思想驾驶模式..

2 weeks later..
经过研发人员的日夜赶工.. 朝鲜的国产新能源汽车大换样..
```
class GreenCar:
    name = "아리랑"
    ...
    def main_idea_drive(self):
        ...
        self.elec_machine.work()
```
这次改造之后将车机界面部分换成了朝文并且增加了主体思想驾驶模式，不过这个模式由于赶工，做的比较粗糙，只增加了一些主体思想新闻、歌曲内容..
因为要彻底改头换面不仅仅要改外观类，而且还要改动外购的"子系统"，这是一项大工程，由于时间紧，任务重，只能优先改改外观部门，再次糊弄下将军了..
